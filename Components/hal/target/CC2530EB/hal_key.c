...
/* CPU port interrupt */
#define HAL_KEY_WORK_CPU_PORT_0_IF P1IF
...
/* Work key is at P1.1 */
#define HAL_KEY_WORK_PORT   P1
#define HAL_KEY_WORK_BIT    BV(1)
#define HAL_KEY_WORK_SEL    P1SEL
#define HAL_KEY_WORK_DIR    P1DIR

/* edge interrupt */
#define HAL_KEY_WORK_EDGEBIT  BV(1)
...
#define HAL_KEY_WORK_ICTLBIT  BV(1) /* P1IEN - P1.1 enable/disable bit */
...
void HalKeyConfig (bool interruptEnable, halKeyCBack_t cback)
{
  ...
  if (Hal_KeyIntEnable)
  {
    ...
    PICTL &= ~(HAL_KEY_WORK_EDGEBIT);    /* Clear the edge bit */
    /* For falling edge, the bit must be set. */
  #if (HAL_KEY_WORK_EDGE == HAL_KEY_FALLING_EDGE)
    PICTL |= HAL_KEY_WORK_EDGEBIT;
  #endif
...
HAL_ISR_FUNCTION( halKeyPort1Isr, P1INT_VECTOR )
{
  ...
  if ((HAL_KEY_WORK_PXIFG & HAL_KEY_WORK_BIT))
  {
    halProcessKeyInterrupt();
  }
